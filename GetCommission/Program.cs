...
namespace GetCommission
{
    ...
    public class QueryString
    {
        ...
        private string GetCommissionTypeGuid(string CheckedLine)
        {
        ...
        {
            string rawText = System.IO.File.ReadAllText(@"d:\Documents\fromGit\C-SharpCode\sql_query_commission_4.txt");
